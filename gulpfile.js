...
function mainScss() {
  ...
  return gulp.src(config.sass.src)
    ...
    .pipe(gulpif(PRODUCTION, cssnano({
      zindex: false,
      discardUnused: true
     }))) // {zindex:false} to prevent override of z-index values -- higher z-index's are needed in our projects to bring objects above bootstrap's default z-index values
