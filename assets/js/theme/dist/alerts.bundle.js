...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/theme/emergency/alerts.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _campusAlertsSheetsAPI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./campusAlertsSheetsAPI.js */ \"./assets/js/theme/emergency/campusAlertsSheetsAPI.js\");\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  gapi.load('client', _campusAlertsSheetsAPI_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n});\n\n//# sourceURL=webpack:///./assets/js/theme/emergency/alerts.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.iterator */ \"./node_modules/core-js/modules/es.array.iterator.js\");\n/* harmony import */ var core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ \"./node_modules/core-js/modules/es.object.to-string.js\");\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ \"./node_modules/core-js/modules/web.dom-collections.iterator.js\");\n/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _simpleSetSheetParameters_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./simpleSetSheetParameters.js */ \"./assets/js/theme/emergency/simpleSetSheetParameters.js\");\n/* harmony import */ var _createAlertsHtml_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createAlertsHtml.js */ \"./assets/js/theme/emergency/createAlertsHtml.js\");\n\n\n\n\n\nvar SHEET_KEY = '1plXBiZY5pVbhNT-mszxEuqCl4zy8wMnz9gXXbbT_yLs';\nvar SHEET_TAB_NAME = 'Alerts Testing';\nvar EMERGENCY_ALERT_DIV_ID = 'emergencyAlerts';\n\nfunction start() {\n  if (!document.getElementById(EMERGENCY_ALERT_DIV_ID)) return; //var t0 = performance.now();\n\n  init(); //var t1 = performance.now();\n  //console.info(\"Call to 'init' took \" + (t1 - t0) + \" milliseconds.\");\n}\n\nfunction init() {\n  var params = {\n    'apiKey': 'AIzaSyCEBsbXfFcdbkASlg-PodD1rT_Fe3Nw62A',\n    'discoveryDocs': ['https://www.googleapis.com/discovery/v1/apis/sheets/v4/rest']\n  };\n  var sheetParams = Object(_simpleSetSheetParameters_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(SHEET_KEY, SHEET_TAB_NAME);\n  gapi.client.init(params).then(function () {\n    // Executes an API request, and returns a Promise.\n    function execute() {\n      return gapi.client.sheets.spreadsheets.values.get(sheetParams).then(function (response) {\n        Object(_createAlertsHtml_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(response);\n      }, function (err) {\n        console.error(\"Execute error\", err);\n      });\n    }\n\n    execute();\n  });\n} // Loads the JavaScript client library and invokes `start` afterwards.\n//    Usage:\n//  gapi.load('client', start);\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (start);\n\n//# sourceURL=webpack:///./assets/js/theme/emergency/campusAlertsSheetsAPI.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.iterator */ \"./node_modules/core-js/modules/es.array.iterator.js\");\n/* harmony import */ var core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_iterator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ \"./node_modules/core-js/modules/es.object.to-string.js\");\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ \"./node_modules/core-js/modules/web.dom-collections.iterator.js\");\n/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _parseMarkdownToHTML_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parseMarkdownToHTML.js */ \"./assets/js/theme/emergency/parseMarkdownToHTML.js\");\n\n\n\n// Custom JS to build an alert message using data coming from a Google Sheets (Using the Sheets API v4)\n// ==================================================================================\n// This exported module requires you pass the function the `response` object from the API call,\n// and `resolve()` from the Promise that the function call is wrapped in (see './campusAlertsSheetsAPI.js')\n\nvar CAMPUS_ALERTS_DIV_ID_STRING = 'emergencyAlerts'; // ID of the div to house campus alerts - already built into the page.\n\nvar BOOTSTRAP_CONTAINER_CLASS = 'container'; // Class used in Bootstrap 4\n\nvar BOOTSTRAP_ROW_CLASS = 'row'; // Class used in Bootstrap 4\n\nvar BOOTSTRAP_COL_CLASS = 'col'; // Class used in Bootstrap 4\n\nvar BOOTSTRAP_CLOSE_CLASS = 'close'; // Class used in Bootstrap 4\n\nvar TRUE_FROM_SHEETS = 'TRUE'; // Because Google Sheets does 'TRUE' & 'FALSE' in all caps, unlike JavaScript\n\nvar FALSE_FROM_SHEETS = 'FALSE'; // Because Google Sheets does 'TRUE' & 'FALSE' in all caps, unlike JavaScript\n\nvar BOOTSTRAP_ALERT_CLASS_ARRAY = ['alert', 'alert-warning']; // BS4 classes for alerts\n\nvar PARAGRAPH_CLASS_ARRAY = ['typography__alert', 'mb-0']; // KCC Gem Theme & Bootstrap 4 class strings in an array\n\nvar ALERTS_VISIBLE_CLASS = 'position__offset-alert--visible';\n\nfunction addClassesToEl(el, classArr) {\n  for (var i = 0, len = classArr.length; i < len; i++) {\n    el.classList.add(classArr[i]);\n  }\n}\n\nfunction appendElementWithNewNode(el, nodeType, classArr) {\n  var newNode = document.createElement(nodeType);\n  var classArrIsNotIterable = typeof classArr === 'string';\n  classArrIsNotIterable ? newNode.classList.add(classArr) : addClassesToEl(newNode, classArr);\n  el.appendChild(newNode);\n  return newNode;\n}\n\nfunction createHTML(SHEET_DATA) {\n  // Finally....after all those checks....we get to do something!\n  var DOM_TARGET = document.getElementById(CAMPUS_ALERTS_DIV_ID_STRING); // This targets an element built into the DOM that we inject everything into.\n\n  var MESSAGE = Object(_parseMarkdownToHTML_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(SHEET_DATA[2]); // The third cell, or third item, in the array\n\n  var container = appendElementWithNewNode(DOM_TARGET, 'div', BOOTSTRAP_CONTAINER_CLASS);\n  var row = appendElementWithNewNode(container, 'div', BOOTSTRAP_ROW_CLASS);\n  var col = appendElementWithNewNode(row, 'div', BOOTSTRAP_COL_CLASS);\n  var alertDiv = appendElementWithNewNode(col, 'div', BOOTSTRAP_ALERT_CLASS_ARRAY);\n  alertDiv.innerHTML = MESSAGE;\n  DOM_TARGET.classList.add(ALERTS_VISIBLE_CLASS);\n}\n\nfunction zeroDatesTime(dateObjectArr) {\n  for (var i = 0, len = dateObjectArr.length; i < len; i++) {\n    dateObjectArr[i].setHours(0, 0, 0, 0);\n  }\n}\n\nfunction checkAlertExpiration(SHEET_DATA) {\n  var d = new Date();\n  var START = new Date(SHEET_DATA[4]);\n  var END = new Date(SHEET_DATA[5]);\n  zeroDatesTime([d, START, END]);\n  var alertIsActiveAndNotExpired = START.getTime() <= d.getTime() && END.getTime() > d.getTime();\n  alertIsActiveAndNotExpired ? createHTML(SHEET_DATA) : null;\n}\n\nfunction init(SHEET_DATA) {\n  var ALERT_HAS_EXPIRATION = SHEET_DATA[3] === TRUE_FROM_SHEETS;\n  ALERT_HAS_EXPIRATION ? checkAlertExpiration(SHEET_DATA) : createHTML(SHEET_DATA);\n}\n\nfunction checkAlertPages(SHEET_DATA) {\n  var DISPLAY_ALERT_ON_ALL_PAGES = SHEET_DATA[1] === TRUE_FROM_SHEETS; // Second cell toggles if it displayes on just homepages or all pages of the sites\n\n  var pathname = window.location.pathname;\n  var locationIsHomepage = pathname === '/';\n\n  if (!DISPLAY_ALERT_ON_ALL_PAGES) {\n    locationIsHomepage ? init(SHEET_DATA) : null;\n  } else {\n    init(SHEET_DATA);\n  }\n}\n\nfunction createAlertsHtml(response) {\n  // Incoming response from our Google Sheet via the Sheets API\n  // This is where the cell values hide in the response object from the Google API.\n  var SHEET_CELL_VALUES_ARRAY = response.result.values; // `values` is an array consisting of an array for each row (i.e an array of arrays)\n\n  var SHEET_DATA = SHEET_CELL_VALUES_ARRAY[2]; // Selecting the third row of the values array. This is where all the important options/data are in the Google Sheet\n\n  var ALERT_VISIBILITY_IS_FALSE = SHEET_DATA[0] === FALSE_FROM_SHEETS; // First cell(SHEET_DATA[0]) is to toggle the alert's visibility.\n\n  if (ALERT_VISIBILITY_IS_FALSE) return;\n  checkAlertPages(SHEET_DATA);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (createAlertsHtml);\n\n//# sourceURL=webpack:///./assets/js/theme/emergency/createAlertsHtml.js?");
